...
const SearchPage = () => {
  ...
  return (
    <div className="w-full min-h-screen bg-white dark:bg-gray-800 px-4 pt-14 md:pt-20 flex flex-col items-center">
      <div className="w-full flex items-center mx-4 bg-gray-100 dark:bg-gray-700 p-2 rounded-3xl">
        <input
          type="text"
          value={searchText}
          onChange={handleChangeInput}
          placeholder="Axtarış edin..."
          className="flex-grow p-2 h-8 focus:outline-none rounded-lg text-gray-700 dark:text-gray-300 bg-transparent"
        />

        <IoIosSearch className="text-gray-400 dark:text-gray-300" size={24} />
      </div>

      <div className=" w-full mt-2 overflow-y-auto h-[75vh]">
